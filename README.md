...
### Notes
I had issues with the rotated views. Otherwise completed the second part without much struggle. 
...
### User Stories
- [x] User need to check what year movies where released. So the app has an the date in the title now. 
...
### Notes
I encounter a few errors when trying to add the date to the title, however I was able to figure out how to format the date of the movies.
